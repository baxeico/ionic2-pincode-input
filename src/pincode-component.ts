...
@Component({
  ...
  template:
    '<ion-backdrop *ngIf="d.enableBackdrop" (click)="bdClick()" [class.backdrop-no-tappable]="!d.enableBackdropDismiss"></ion-backdrop>' +
    ...
    '     <ion-grid> ' +
    '       <ion-row> ' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(1)">1</button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(2)">2</button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(3)">3</button></ion-col>' +
    '       </ion-row>' +
    '       <ion-row> ' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(4)">4</button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(5)">5</button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(6)">6</button></ion-col>' +
    '       </ion-row>' +
    '       <ion-row> ' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(7)">7</button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(8)">8</button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(9)">9</button></ion-col>' +
    '       </ion-row>' +
    '       <ion-row> ' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="restoreClick()">' +
    '           <ion-icon name="refresh">' +
    '         </ion-icon></button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="numClick(0)">0</button></ion-col>' +
    '         <ion-col><button ion-button [color]="d.buttonsColor" (click)="delClick()">' +
...
export class PincodeCmp {
  ...
  bdClick() {
    if (this.enabled && this.d.enableBackdrop && this.d.enableBackdropDismiss) {
